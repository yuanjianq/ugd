	...
	<div class="tabcont">
		<div class="chart_cont p10">
			<div class="datacont clearfix">
				<div id='containerGirdbirt03${param.chartname}' class="datainfo clearfix" style="min-width:700px;">
				</div>
			</div>
		</div>
	</div>
...
<script>
//girdbirt03模板的参数
function girdbirt03param(content){
	this.content=content;
	this.showSort='';
	this.showLink;
}
//girbirt02模板的展示函数
function showgirdbirt03(param,chartname){
	var containerGirdbirt03 = $('#containerGirdbirt03');
	if(chartname!=null){
		containerGirdbirt03 = $('#containerGirdbirt03'+chartname);
	}
	//拼接要展示的报表
	...
	containerGirdbirt03.empty();
	containerGirdbirt03.append(birtContent);
