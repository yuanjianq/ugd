...
function downExcelFile(){
	...
	RptManager.genReportFile(rtpparams,'ty_query_device_day.rptdisger',{
...
function skipDetail(dataTime){
	...
	var urlParam = "dataTime="+dataTime;
	jQuery.ajax({
		type : "POST",
...
function querygirdPartPage(currentPage){
	...
	//通过ajax查询后台数据
	RptManager.genReportDataToHtmlAndCount(rtpparams,'ty_query_device_day.rptdisger', function(content){
