...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption" style="height: 20px;">
			<i class="icon-reorder"></i>七日留存率报表
		</div>
		<div class="tools">
...
function downExcelFile(){
	...
	RptManager.genReportFile(rtpparams,'sevenday_view_count.rptdisger',{
...
function querygirdPartPage(currentPage){
	...
	//通过ajax查询后台数据
	RptManager.genReportDataToHtmlAndCount(rtpparams,'sevenday_view_count.rptdisger', function(content){
