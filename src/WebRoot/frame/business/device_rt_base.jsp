...
function downExcelFile(){
	...
	RptManager.genReportFile(rtpparams,'query_device_rt_base.rptdisger',{
...
function querygirdPartPage(currentPage){
	...
	//通过ajax查询后台数据
	RptManager.genReportDataToHtmlAndCount(rtpparams,'query_device_rt_base.rptdisger', function(content){
