...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption" style="height: 20px;">
			<i class="icon-reorder"></i>天音盒子详细信息
		</div>
		<div class="tools">
...
function downExcelFile(){
	...
	//通过ajax查询后台数据
	RptManager.genReportFile(rtpparams,'ty_query_rt_detail.rptdisger',{
...
function querygirdPartPage(currentPage){
	...
	//通过ajax查询后台数据
	RptManager.genReportDataToHtmlAndCount(rtpparams,'ty_query_rt_detail.rptdisger', function(content){
		parampage.count=parseInt(content[1]);
		//构造报表模板参数，并展示模板
		var param = new girdbirt01param(content[0],parampage);
		RptManager.genReportDataToHtml(rtpparams,'ty_query_rt_detail_total.rptdisger', function(content){
// 			构造报表模板参数，并展示模板
