...
function downExcelFile(){
	...
	RptManager.genReportFile(rtpparams,'everyday_data_count.rptdisger',{
...
function querygirdPartPage(currentPage){
	...
	//alert(startTime+"     "+endTime+"      "+parampage.length*(parampage.currentPage-1)+"      "+parampage.length);
	//通过ajax查询后台数据
	RptManager.genReportDataToHtmlAndCount(rtpparams,'everyday_data_count.rptdisger', function(content){
