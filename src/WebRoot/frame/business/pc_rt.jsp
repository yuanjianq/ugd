...
function downExcelFile(){
	...
	//构造ajax后台数据查询的参数
	var rtpparams = {};
	rtpparams.boxids = " AND  r.client_uid IN ("+boxids+") ";
	rtpparams.start_time=startTime;
	rtpparams.end_time=endTime;
	RptManager.genReportFile(rtpparams,'query_pc_rt.rptdisger',{
...
function querygirdPartPage(currentPage){
	...
	rtpparams.end_time=endTime;
	//通过ajax查询后台数据
	RptManager.genReportDataToHtml(rtpparams,'query_pc_rt.rptdisger', function(content){
		//构造报表模板参数，并展示模板
