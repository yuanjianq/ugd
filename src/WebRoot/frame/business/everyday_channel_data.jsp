...
function downExcelFile(){
	...
	RptManager.genReportFile(rtpparams,'everyday_channel_data.rptdisger',{
...
function querygirdPartPage(currentPage){
	...
	//alert(startTime+"      "+parampage.length*(parampage.currentPage-1)+"      "+parampage.length+"   "+channel_name+"   "+product_name);
	//通过ajax查询后台数据
	RptManager.genReportDataToHtmlAndCount(rtpparams,'everyday_channel_data.rptdisger', function(content){
