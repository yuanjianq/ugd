...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption" style="height: 20px;">
			<i class="icon-reorder"></i>天音盒子实时数据
		</div>
		<div class="tools">
...
function downExcelFile(){
	...
	RptManager.genReportFile(rtpparams,'ty_query_device_rt.rptdisger',{
...
function querygirdPartPage(currentPage){
	...
	//通过ajax查询后台数据
	RptManager.genReportDataToHtmlAndCount(rtpparams,'ty_query_device_rt.rptdisger', function(content){
